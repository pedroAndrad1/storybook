...
import { Provider as Provider$1 } from '@radix-ui/react-toast';
...
declare const StyledContent: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<_radix_ui_react_tooltip.TooltipContentProps & react.RefAttributes<HTMLDivElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        error: string;
...
declare const Tooltip: ({ contentProps, portalProps, rootProps, trigger, content, }: TooltipProps) => react_jsx_runtime.JSX.Element;

interface TooltipProviderProps extends ComponentProps<typeof Provider> {
}
declare function TooltipProvider({ children, ...providerProps }: TooltipProviderProps): react_jsx_runtime.JSX.Element;

declare const StyledRoot: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<_radix_ui_react_toast.ToastProps & react.RefAttributes<HTMLLIElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        error: string;
...
interface ToastProps extends ComponentProps<typeof StyledRoot> {
    title: string;
    description: string;
}
declare const Toast: ({ title, description, duration, ...rootProps }: ToastProps) => react_jsx_runtime.JSX.Element;

interface ToastProviderProps extends ComponentProps<typeof Provider$1> {
}
declare function ToastProvider({ children, label, swipeDirection, swipeThreshold, }: ToastProviderProps): react_jsx_runtime.JSX.Element;
...
export { Avatar, type AvatarProps, Box, type BoxProps, Button, type ButtonProps, Checkbox, type CheckboxProps, Heading, type HeadingProps, MultiStep, type MultiStepProps, Text, TextArea, type TextAreaProps, TextInput, type TextInputProps, type TextProps, Toast, type ToastProps, ToastProvider, Tooltip, type TooltipProps, TooltipProvider, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
